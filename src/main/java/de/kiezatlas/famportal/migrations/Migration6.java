...
public class Migration6 extends Migration {
    ...
    public void run() {
        ...
        Topic familieUndPartnerschaft = dm4.getTopicByUri("famportal.category-e99c03aa-a0cb-44e4-a518-3ab4b7062679-de_DE-1");
        Topic beratungUndUnterstützung = dm4.getTopicByUri("famportal.category-a0e061b5-83b0-4c64-818c-a53c3137c2c9-de_DE-1");
        Topic ausbildungUndBeruf = dm4.getTopicByUri("famportal.category-20186c9c-a413-421f-8f1e-a80fb266d79f-de_DE-1");
        Topic lebenslagen = dm4.getTopicByUri("famportal.category-bb19be3d-f705-4516-83f3-517ca277a73f-de_DE-1");
        Topic familiePlus = dm4.getTopicByUri("famportal.category-b67cf945-4ffb-4916-8f69-2e25b271a9b1-de_DE-1");
        ...
        for (Topic topic : dm4.getTopicsByType("famportal.category")) {
            ...
            if (topic.getUri().equals("famportal.category-68235a12-f151-494c-8e5d-c2dd5492449a-de_DE-1")) { //
                ...
                ChildTopicsModel categoryTopicModel = mf.newChildTopicsModel();
                ...
                TopicModel category = mf.newTopicModel("famportal.category", categoryTopicModel);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Trennung und Scheidung"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Kinderbetreuung und Kita"));
                ...
                TopicModel categoryModel = mf.newTopicModel("famportal.category", categoryTopicModel);
                ...
                ChildTopicsModel suchtCategoryModel = mf.newChildTopicsModel();
                suchtCategoryModel.add("famportal.category", suchterkrankung);
                TopicModel category = mf.newTopicModel("famportal.category", suchtCategoryModel);
                ...
                ChildTopicsModel neuTopicModel = mf.newChildTopicsModel();
                neuTopicModel.add("famportal.category", neuInDerStadt);
                TopicModel neuModel = mf.newTopicModel("famportal.category", neuTopicModel);
                ...
                ChildTopicsModel todesfallModel = mf.newChildTopicsModel();
                todesfallModel.add("famportal.category", todesfall);
                TopicModel todesfallTopicModel = mf.newTopicModel("famportal.category", todesfallModel);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Bund f\u00fcrs Leben"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name",
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Arbeitslosigkeit"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
            } else if (topic.getUri().equals("famportal.category-d8a993b2-8dd1-4ab5-8033-d9a542ce01ac-de_DE-1")) {
                // Rename to "Schule"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Schule"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
            } else if (topic.getUri().equals("famportal.category-56db817c-e57d-41a5-8b9f-a9ddfb789a28-de_DE-1")) {
                // Rename to "Ausbildung"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Ausbildung"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "\u00dcbergang " +
                        "Schule/Beruf"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Weiterbildung"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
            } else if (topic.getUri().equals("famportal.category-bd769edb-2ff1-456d-b57e-8f81d1a4fbdf-de_DE-1")) {
                // Rename to "Studium"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Studium"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
            } else if (topic.getUri().equals("famportal.category-a73511a2-64f4-437c-accb-b4955b512865-de_DE-1")) {
                // Rename to "Leben mit Krankheit"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Leben mit Krankheit"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Vorsorge von Krankheit, Unfall, Tod"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
            } else if (topic.getUri().equals("famportal.category-fc8c1bac-473d-4d57-8e0f-51161cc1ddaa-de_DE-1")) {
                // Rename to "Im Ruhestand"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Ruhestand"));
                // Move to "Lebenslagen"
                assignTopicNewParent(topic, lebenslagen);
                // Remove reference to "Ruhestand" and add one to "Lebenslagen" instead
                Topic erbenUndVererben = dm4.getTopicByUri("famportal" +
                ...
                ChildTopicsModel babyCategoryModel = mf.newChildTopicsModel();
                babyCategoryModel.add("famportal.category", babys);
                TopicModel babyCategory = mf.newTopicModel("famportal.category", babyCategoryModel);
                ...
                ChildTopicsModel kinderCategoryModel = mf.newChildTopicsModel();
                kinderCategoryModel.add("famportal.category", kinder);
                TopicModel kinderCategory = mf.newTopicModel("famportal.category", kinderCategoryModel);
                ...
                ChildTopicsModel jungeErwachseneCategoryModel = mf.newChildTopicsModel();
                jungeErwachseneCategoryModel.add("famportal.category", jungeErwachseneModel);
                TopicModel jungeErwachseneCategory = mf.newTopicModel("famportal.category", jungeErwachseneCategoryModel);
                ...
                ChildTopicsModel mutterModelCategoryModel = mf.newChildTopicsModel();
                mutterModelCategoryModel.add("famportal.category", mutterModel);
                TopicModel mutterCategory = mf.newTopicModel("famportal.category", mutterModelCategoryModel);
                ...
                ChildTopicsModel vaterModelCategory = mf.newChildTopicsModel();
                vaterModelCategory.add("famportal.category", vaterModel);
                TopicModel vaterCategory = mf.newTopicModel("famportal.category", vaterModelCategory);
                ...
                ChildTopicsModel stepParentsModelCategory = mf.newChildTopicsModel();
                stepParentsModelCategory.add("famportal.category", stepParents);
                TopicModel stepParentsCategory = mf.newTopicModel("famportal.category", stepParentsModelCategory);
                ...
                ChildTopicsModel alleinerziehendModelCategory = mf.newChildTopicsModel();
                alleinerziehendModelCategory.add("famportal.category", alleinerziehend);
                TopicModel alleinerziehendCategory = mf.newTopicModel("famportal.category", alleinerziehendModelCategory);
                ...
                ChildTopicsModel menschenNotModelCategory = mf.newChildTopicsModel();
                menschenNotModelCategory.add("famportal.category", menschenNot);
                TopicModel menschenNotCategory = mf.newTopicModel("famportal.category", menschenNotModelCategory);
                ...
                ChildTopicsModel patchworkfamilienCategoryModel = mf.newChildTopicsModel();
                patchworkfamilienCategoryModel.add("famportal.category", patchworkfamilien);
                TopicModel patchworkCategory = mf.newTopicModel("famportal.category", patchworkfamilienCategoryModel);
                ...
                ChildTopicsModel regenbogenfamilienModel = mf.newChildTopicsModel();
                regenbogenfamilienModel.add("famportal.category", regenbogenfamilien);
                TopicModel regenbogenCategory = mf.newTopicModel("famportal.category", regenbogenfamilienModel);
                ...
                ChildTopicsModel verwandteModel = mf.newChildTopicsModel();
                verwandteModel.add("famportal.category", verwandte);
                TopicModel verwandteCategory = mf.newTopicModel("famportal.category", verwandteModel);
                ...
                ChildTopicsModel menschenMitModel = mf.newChildTopicsModel();
                menschenMitModel.add("famportal.category", menschenMit);
                TopicModel menschenMitCategory = mf.newTopicModel("famportal.category", menschenMitModel);
                ...
                ChildTopicsModel menschenSuchtModel = mf.newChildTopicsModel();
                menschenSuchtModel.add("famportal.category", menschenSucht);
                TopicModel menschenSuchtCategory = mf.newTopicModel("famportal.category", menschenSuchtModel);
                ...
                ChildTopicsModel ehrenamtlicheModel = mf.newChildTopicsModel();
                ehrenamtlicheModel.add("famportal.category", ehrenamtliche);
                TopicModel ehrenamtlicheCategory = mf.newTopicModel("famportal.category", ehrenamtlicheModel);
                ...
                ChildTopicsModel unternehmenModel = mf.newChildTopicsModel();
                unternehmenModel.add("famportal.category", unternehmen);
                TopicModel unternehmenCategory = mf.newTopicModel("famportal.category", unternehmenModel);
                ...
                ChildTopicsModel vinModel = mf.newChildTopicsModel();
                vinModel.add("famportal.category", vin);
                TopicModel vinCategory = mf.newTopicModel("famportal.category", vinModel);
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Schulkinder"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Jugendliche"));
                // Remove reference at "Kinder und Jugendliche"
                removeParentalReference(topic, "famportal.category-0e103816-0320-4c22-8be9-3af0544299c0-de_DE-1");
                // Move to "FAmilie+"
                assignTopicNewParent(topic, familiePlus);
                ...
                // Rename to "Eltern"
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Eltern"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Menschen mit Krankheit"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Migranten und " +
                        "Fl\u00fcchtlinge"));
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Pflegebed\u00fcrftige"));
                // Add new reference to "Familie+"
                assignTopicNewParent(topic, familiePlus);
            }
    ...
    private void removeParentalReference(Topic element, String famportalCategoryTopicURI) {
        Topic parent = dm4.getTopicByUri(famportalCategoryTopicURI);
        ChildTopicsModel updateModel = mf.newChildTopicsModel();
        updateModel.addDeletionRef("famportal.category", element.getId());
        TopicModel category = mf.newTopicModel("famportal.category", updateModel);
        parent.update(category);
    }

    private TopicModel createFamportalCategoryTopicModel(String name, int order, String uriPart) {
        // ..) Create new child topics
        ChildTopicsModel categoryChilds = mf.newChildTopicsModel();
        ...
        return mf.newTopicModel("famportal." + uriPart, "famportal.category", categoryChilds);
    }
