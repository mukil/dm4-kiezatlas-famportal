    ...
    public void run() {
        ...
        for (Topic topic : dms.getTopics("famportal.category", 0).getItems()) {
            ...
            // --- Familie+ ---
                ...
                TopicModel kinderCategory = new TopicModel(kinderCategoryModel);
                ...
                TopicModel jungeErwachseneCategory = new TopicModel(jungeErwachseneCategoryModel);
                ...
                TopicModel mutterCategory = new TopicModel(mutterModelCategoryModel);
                ...
                TopicModel vaterCategory = new TopicModel(vaterModelCategory);
                ...
                TopicModel menschenNotCategory = new TopicModel(menschenNotModelCategory);
                ...
                TopicModel patchworkCategory = new TopicModel(patchworkfamilienCategoryModel);
                ...
                TopicModel regenbogenCategory = new TopicModel(regenbogenfamilienModel);
                ...
                TopicModel verwandteCategory = new TopicModel(verwandteModel);
                ...
                TopicModel menschenMitCategory = new TopicModel(menschenMitModel);
                ...
                TopicModel ehrenamtlicheCategory = new TopicModel(ehrenamtlicheModel);
