...
public class Migration5 extends Migration {
    ...
    public void run() {
        ...
        Topic bundFuersLebenCategory = dm4.getTopicByUri("famportal.category-68235a12-f151-494c-8e5d-c2dd5492449a-de_DE-1");
        Topic notlagenCategory = dm4.getTopicByUri("famportal.category-6f01c6f8-ccc7-4e37-a751-34590de758de-de_DE-1");
        Topic elternWerdenCategory = dm4.getTopicByUri("famportal.category-77726c72-c8eb-46ca-871e-0ef30e7e951e-de_DE-1");
        Topic elternSeinCategory = dm4.getTopicByUri("famportal.category-039e72df-4f50-4f0c-b744-caf52d18fc77-de_DE-1");
        Topic verwandschaftCategory = dm4.getTopicByUri("famportal.category-7a33ad19-5075-4f6d-8589-f03e996fccba-de_DE-1");
        ...
        for (Topic topic : dm4.getTopicsByType("famportal.category")) {
            ...
            if (topic.getUri().equals("famportal." + "category-973782a5-e91f-44af-b313-22f6c736d4c2-de_DE-1")) {
                ...
                TopicModel childsTopicModel = mf.newTopicModel("famportal.category-cd5e8503-fa57-4a38-bc8e-0ab32bfd8e7e-de_DE-1",
                ...
                categoryTopicModel.add("famportal.category", childsTopicModel);
                // ..) Update our current topic with appending our new composite child topic
                TopicModel category = mf.newTopicModel(null, categoryTopicModel);
            ...
            // 1.3) Fix typo in name of "Bund fuers Leben eingehen"
                ...
                topic.setChildTopics(mf.newChildTopicsModel().put("famportal.category.name", "Bund f\u00fcrs Leben eingehen"));
            ...
            // 1.4) Remove \"Bund fürs Leben\" and \"Notlagen\" tree from \"Themen\"
                ...
                ChildTopicsModel deleteRef = mf.newChildTopicsModel();
                ...
                topic.update(mf.newTopicModel("famportal.category", deleteRef));
            ...
            // 1.5) Add \"Bund fürs Leben\" tree to \"Familie + Partnerschaft\"
                ...
                ChildTopicsModel addChildRef = mf.newChildTopicsModel();
                addChildRef.addRef("famportal.category", bundFuersLebenCategory.getId());
                topic.update(mf.newTopicModel("famportal.category", addChildRef));
